...
<section class="wkode-about-us pt-96 mt-36 md:pt-80 font-montserrat" id="sobre">
    <div class="wkode-about-us__wrapper container">
        ...
        <h3 data-entrance="from-left" class="wkode-about-us__text font-bold text-oli-primary-blue text-4xl px-12 mt-16">
        ...
        <div class="wkode-about-us__wrapper grid grid-cols-1 sm:grid-cols-2 mt-28">
            <div class="wkode-about-us__main-image p-0 md:pr-9 mb-60 md:mb-0">
                <img data-entrance="from-left" class="w-8/12 m-auto" src="<?php echo get_theme_file_uri('/assets/img/about-us-main.png'); ?>" alt="" >
            </div>
    ...
    <div class="wkode-numbers__wrapper text-white grid grid-cols-1 md:grid-cols-3 container gap-9">
        <div class="wkode-numbers__card mb-20 md:mb-0">
            ...
            <div class="wkode-numbers__number text-center mb-7">
                <h2 data-entrance="from-left" class="timer text-7xl font-black" data-to="2193" data-speed="1500"></h2>
            </div>
        ...
        <div class="wkode-numbers__card mb-20 md:mb-0" >
            ...
            <div class="wkode-numbers__number text-center mb-7">
                <h2 data-entrance="fade" class="timer text-7xl font-black" data-to="1200" data-speed="1500"></h2>
            </div>
            <div class="wkode-numbers__text">
        ...
        <div class="wkode-numbers__card ">
            ...
            <div class="wkode-numbers__number text-center mb-7">
                <h2 data-entrance="from-right" class="timer text-7xl font-black" data-to="1109" data-speed="1500"></h2>
            </div>
            <div class="wkode-numbers__text">
